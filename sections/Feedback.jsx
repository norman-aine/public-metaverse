    ...
    >
      ...
      >
        ...
        <p className='mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white'>
          "With the development of today's technology, metaversus is very useful for today's work, or can be called web 3.0. by using metaversus you can use it as anything"
        </p>
      </motion.div>
      <motion.div
